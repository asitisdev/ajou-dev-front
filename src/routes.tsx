...
import ChangePW from './pages/ChangePW.tsx';
  ...
  return (
    <Routes>
      <Route path="/" element={<Root />}>
        ...
        <Route path="/changepw" element={isAuth ? <ChangePW /> : <Navigate to="/login" />}></Route>
        ...
        <Route path="/question/:postNum" element={<Question />}></Route>
